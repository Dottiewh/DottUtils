...
- #### **Lore:** Cada lista (-), es una línea independiente. Recomendado poner entre " ", y acepta codigos de colores básicos.
...
#### **UseCooldown**
- #### cooldown_group
  - #### Los items que estén en el mismo grupo, compartirán el cooldown.
- #### cooldown_seconds
...
Items:
  ...
  bow:
    ...
    CustomData:
      onShot:
        particles: END_ROD;1;2;1;0;5;true
  fishing_rod:
    ...
    CustomData:
      onFish:
        particles: END_ROD;1;2;1;0.1;5;false

```
### Resumen de CustomData
#### onAttack/onShot/onFish _(Generalistas)_
- #### effectapply:
  - #### No aplica para onFish.
  - #### Efecto a aplicar
...
## 23/02/2026
#### _Lo de CustomData vendrá en la update 1.2.3_